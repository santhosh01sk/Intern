...
import {
  BookOpen, PlusCircle, Pencil, Trash2, ChevronUp, ChevronDown,
...
const CoursesManagement = () => {
  ...
  const [deleteConfirm, setDeleteConfirm] = useState(null); // course to delete
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto space-y-8 animate-fadeIn">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 pb-6 border-b border-slate-200 dark:border-slate-800">
        <div className="flex items-center gap-4">
          <button
            ...
            className="p-2.5 rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-950 text-slate-500 hover:text-slate-800 dark:hover:text-slate-200 transition-all cursor-pointer focus:outline-none focus:ring-2 focus:ring-indigo-500"
          ...
          <div>
            ...
            <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">
              Add new curricula, update descriptions, and edit categories.
            </p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            onClick={openCreate}
            className="flex items-center gap-2 bg-emerald-600 hover:bg-emerald-700 text-white font-bold py-3 px-5 rounded-xl shadow-lg shadow-emerald-600/15 transition-all cursor-pointer focus:outline-none focus:ring-2 focus:ring-emerald-500"
          >
            <PlusCircle size={16} />
                ...
                <tr>
                  <td colSpan={5} className="py-20 text-center">
                    <div className="flex flex-col items-center gap-3 text-slate-400 dark:text-slate-500">
                      ...
                      <p className="text-xs">Try adjusting your filters or create a new course.</p>
                      <button
                        onClick={openCreate}
                    ...
                    <td className="px-5 py-4">
                      <div className="flex items-center justify-end gap-1.5">
                        ...
                        <button
                          ...
                          title="Edit course"
                          className="p-2 rounded-lg text-amber-500 hover:bg-amber-50 dark:hover:bg-amber-950/30 transition-all cursor-pointer focus:outline-none focus:ring-2 focus:ring-amber-400"
                        >
                          <Pencil size={15} />
                        </button>
                        {/* Delete */}
                        <button
                          ...
                          title="Delete course"
                          className="p-2 rounded-lg text-rose-500 hover:bg-rose-50 dark:hover:bg-rose-950/30 transition-all cursor-pointer focus:outline-none focus:ring-2 focus:ring-rose-400"
                        >
                          <Trash2 size={15} />
                        </button>
                      </div>
      ...
      {deleteConfirm && (
        ...
        >
          <div className="bg-white dark:bg-slate-950 rounded-2xl shadow-2xl border border-slate-200 dark:border-slate-800 p-6 w-full max-w-sm space-y-4"
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <h3 className="font-bold text-slate-800 dark:text-white text-base">Delete Course?</h3>
                <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">
                  <span className="font-semibold text-slate-700 dark:text-slate-200">{deleteConfirm.title}</span> will be permanently removed.
            ...
            <div className="flex gap-3">
              <button
                ...
                className="flex-1 bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-300 font-bold py-2.5 rounded-xl transition-all cursor-pointer focus:outline-none focus:ring-2 focus:ring-slate-400"
              >
                Cancel
              </button>
              <button
                ...
                className="flex-1 flex items-center justify-center gap-2 bg-rose-600 hover:bg-rose-700 text-white font-bold py-2.5 rounded-xl transition-all cursor-pointer disabled:opacity-60 shadow-lg shadow-rose-600/15 focus:outline-none focus:ring-2 focus:ring-rose-500"
              >
